...
import Login from './Login';
 ...
 function Navbar() {
  ...
  <div className={` w-100% md:px-20 px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white ${sticky?"sticky-navbar shadow-md bg-base-200 duration-200 transition-all ease-in-out":""}`}>
  ...
  <label className="input input-bordered flex items-center gap-2 px-3 py-2 border rounded-md ">
  ...
  <svg
    ...
    <a className="bg-black text-white p-3 ml-2 rounded-md hover:bg-slate-800 duration-800 cursor-pointer" 
